      ...
      <div class="col-lg-8 col-lg-offset-2">
          <div class="panel panel-default">
              <div class="panel-body">
                  <div class="row">
                      <div class="col-lg-12">
                        {!! Form::open(['route' => ['admin.movies.update', $movie->id], 'method' => 'PUT', 'class' =>'form-horizontal', 'files' => true]) !!}
                        <div class="form-group">
                            {!! Form::label('title', 'Título', ['class' => 'col-sm-2 control-label']) !!}
                            <div class="col-sm-10">
                                {!! Form::text('title', $movie->title, ['class' => 'form-control', 'placeholder' => 'Titulo de la película', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            {!! Form::label('resume', 'Resumen', ['class' => 'col-sm-2 control-label']) !!}
                            <div class="col-sm-10">
                                {!! Form::textarea('resume', $movie->resume, ['class' => 'form-control', 'placeholder' => 'Resumen', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            {!! Form::label('category_id', 'Categoría', ['class' => 'col-sm-2 control-label']) !!}
                            <div class="col-sm-10">
                                {!! Form::select('category_id', $categories, $movie->category->id, ['class' => 'form-control', 'placeholder'=>'Seleccione una categoría', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            {!! Form::label('visibility', 'Visibilidad', ['class' => 'col-sm-2 control-label']) !!}
                            <div class="col-sm-10">
                                {!! Form::select('visibility', ['member' => 'Todos', 'premium' => 'Premium'], $movie->visibility, ['class' => 'form-control', 'required']) !!}
                            </div>
                        </div>
                        <div class="form-group">
